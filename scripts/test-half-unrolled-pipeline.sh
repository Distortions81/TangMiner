...
# Generate and directly verify the two-cycle folded SHA256d pipeline.
...
mkdir -p build/half-unrolled-pipeline-sim
TANGMINER_HALF_UNROLLED_SIM_DIR=build/half-unrolled-pipeline-sim \
  "$sbt" "runMain tangminer.GenerateHalfUnrolledPipelineSimVerilog"

...
SPINAL_LANE_PERIOD_CYCLES ?= $(shell expr $(SPINAL_BASE_PERIOD_CYCLES) \* $(SPINAL_ROUND_CYCLE_MULTIPLIER) + $(SPINAL_PASS_OUTPUT_CYCLES) + $(SPINAL_COMPRESSOR_OUTPUT_CYCLES) + $(SPINAL_FIRST_PASS_FEEDFORWARD_CYCLES))
